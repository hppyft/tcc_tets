    ...
    public static String[] getTipoCargaList() {
        if (tipoCargaList == null) {
            tipoCargaList = new String[]{
                    ...
                    "FSC 1,3 - Pavimentos que necessitam de um desempenho acima do normal",
                    "FSC 1,4 - Pavimentos que necessitam de um desempenho acima do normal",
                    "FSC 1,5 - Pavimentos que necessitam de um desempenho acima do normal"};
        }
